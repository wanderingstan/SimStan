...
$MYSQL_USER = 'SIMSTAN_DB_USERNAME';
$MYSQL_PASSWD = 'SIMSTAN_DB_PASSWORD';

// Backup destination (will be created if not already existing)
$BACKUP_DEST = '/home/wanderin/backups';
// $BACKUP_DEST = '/home/wanderin/public_html/simstan.com/html/backup';
...
$BACKUP_NAME = 'simstan_mysql_backup_' . date('Y-m-d');
